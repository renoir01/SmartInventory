...
def main():
    ...
    db_files = [
        ...
        "inventory.db.backup_20250528_111358",  # Today's backup
        "new_inventory.db",  # Another database file
        "new_inventory.db.backup_20250408_185759",  # April backup
        "new_inventory.db.old"  # Old database file
    ]
    
    print("SmartInventory Database Backup Checker")
    print("======================================")
